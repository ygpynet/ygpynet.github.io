...
export default {
    '/vpn/': [
        ...
        },
        {
            text: '赞助商广告',
            items: [
                { text: '<img class="rounded-lg" width="208" height="370" src="/images/vpn/duolaameng/duolaameng-vertical-banner.webp" alt="哆啦 A 梦">', link: 'https://ygpy.yyds2-doraemon.art/#/register?code=7j3dYEtw' }
            ]
        },
        {
