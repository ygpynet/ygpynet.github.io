<template>
  <div ref="headerRef">
    <button v-if="isLoaded" :class="headerClasses" type="button" @click="togglePanel">
      <slot />
      <svg :class="arrowClasses" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path
